...
export const getBanners = createAsyncThunk(
  "banner/getAll",
  async (params: { limit?: number; page?: number; isActive?: boolean } = {}) => {
...
export const getBannersAdmin = createAsyncThunk(
  "banner/getAllAdmin",
  async (params: { limit?: number; page?: number; search?: string } = {}) => {
...
export const createBanner = createAsyncThunk(
  "banner/create",
  async (data: CreateBannerPayload) => {
...
export const updateBanner = createAsyncThunk(
  "banner/update",
  async ({ id, data }: { id: string; data: UpdateBannerPayload }) => {
    const formData = new FormData();
