              ...
              <nav className="flex flex-col gap-1">
                {ADMIN_NAVIGATION.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <item.icon className={cn("h-4 w-4", isActive && "text-[#E53935]")} />
                ...
                >
                  <item.icon
                    className={cn(
                      ...
                      isActive ? "text-[#E53935]" : "text-muted-foreground group-hover:text-foreground"
                    )}
                  />
                  {!isCollapsed && (
                    <>
                      ...
                      {item.badge && (
                        <Badge 
                          className="bg-[#E53935]/10 text-[#E53935] text-[10px] px-1.5 py-0 h-4 border-0"
                        >
                          {item.badge}
                        </Badge>
                      )}
