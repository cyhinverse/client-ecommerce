  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7] dark:bg-[#000000] flex">
      ...
      <Sheet open={sidebarOpen} onOpenChange={setSidebarOpen}>
        <SheetContent side="left" className="w-[280px] p-0 border-r-0 bg-[#F5F5F7]/95 dark:bg-[#1C1C1E]/95 backdrop-blur-xl">
      ...
      >
         <div className="flex h-16 items-center justify-between px-6 border-b border-border/40">
            ...
            <Button
              ...
              className={cn("h-8 w-8 ml-auto text-muted-foreground hover:text-foreground", isCollapsed && "mx-auto")}
            >
            ...
            <nav className="flex flex-col gap-1">
               {ADMIN_NAVIGATION.map((item) => {
                  ...
                  return (
                     ...
                     >
                        <item.icon className={cn("h-5 w-5 shrink-0 transition-colors", isActive ? "text-blue-600 dark:text-blue-400" : "text-muted-foreground group-hover:text-foreground")} />
