...
export default function SellerRegisterPage() {
  ...
  // Check if user already has a shop (only if they can have one)
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error || "Đăng ký shop thất bại");
    }
  };
      ...
      <div className="max-w-[600px] mx-auto">
        ...
        <div className="bg-white rounded border border-[#f0f0f0] p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-800">Đăng ký bán hàng</h1>
              <p className="text-sm text-gray-500">Tạo shop của bạn trên nền tảng</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              <h2 className="font-medium text-gray-800 border-b pb-2">Thông tin Shop</h2>
              <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">Click để upload</p>
                </div>
                <div>
