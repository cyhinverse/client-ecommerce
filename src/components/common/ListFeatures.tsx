      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {features.map((feature, index) => (
          <Card
            ...
            className={`flex flex-col w-full aspect-square justify-center cursor-pointer items-center p-6 bg-white border-0 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 ease-in-out ${
          ...
          >
            <div className={`w-12 h-12 rounded-full flex items-center justify-center mb-4 transition-colors duration-300 ${
              currentIndex === index && isClient ? "bg-white text-black" : "bg-gray-100 text-gray-600"
            }`}>
            ...
            <CardTitle className={`text-center text-sm font-medium leading-tight ${
              currentIndex === index && isClient ? "text-white" : "text-gray-900"
            }`}>
              {feature}
            </CardTitle>
          </Card>
