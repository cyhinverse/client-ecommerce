  ...
  switch (type) {
    case "order":
      switch (status) {
        case "delivered":
          return (
            <Badge className={`bg-success/10 text-success hover:bg-success/20 ${className || ""}`}>
        ...
        case "shipped":
          return (
            <Badge className={`bg-info/10 text-info hover:bg-info/20 ${className || ""}`}>
        ...
        case "processing":
          return (
            <Badge className={`bg-warning/10 text-warning hover:bg-warning/20 ${className || ""}`}>
        ...
        case "cancelled":
          return (
            <Badge
              variant="outline"
              className={`bg-destructive/10 text-destructive border-destructive/20 ${className || ""}`}
            >
    ...
    case "product":
      switch (status) {
        case "active":
          return <Badge className={`bg-success ${className || ""}`}>Đang bán</Badge>;
        case "out_of_stock":
    ...
    case "user":
      switch (status) {
        case "active":
          return <Badge className={`bg-success ${className || ""}`}>Đang hoạt động</Badge>;
        case "inactive":
    ...
    case "role":
      switch (status) {
        case "admin":
          return (
            <Badge className={`bg-primary/10 text-primary hover:bg-primary/20 ${className || ""}`}>
