          ...
          <section className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1400px]">
            <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
              <div>
                ...
                <p className="text-muted-foreground text-lg max-w-xl">
                  Explore our comprehensive collection of premium products, curated just for you.
                </p>
              </div>
              <Link
                href="/categories"
            ...
            >
              {categories.map((cat, i) => {
                // Bento logic: First item spans 2 cols & 2 rows (large square)
                // Second item spans 2 cols (wide rectangle)
                // Rest are 1 col
                const isLarge = i === 0;
                ...
                return (
                  ...
                  >
                    <Link href={`/categories/${cat.slug}`} className="block w-full h-full">
                        ...
                        <div className={`absolute inset-0 bg-gradient-to-br ${getGradient(i)} opacity-50 transition-opacity duration-500 group-hover:opacity-70`} />
                        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-white/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                        ...
                        <div className="absolute inset-0 flex flex-col justify-between p-6 md:p-8">
                            ...
                            <div>
                                ...
                                <h3 className={`font-bold text-foreground leading-tight group-hover:translate-x-1 transition-transform duration-300 ${isLarge ? "text-4xl md:text-5xl" : "text-2xl md:text-3xl"}`}>
                                    {cat.name}
                                </h3>
                            </div>
                        </div>
